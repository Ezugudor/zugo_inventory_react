...
import Style from "./SupplyView.module.css";
...
export const SupplyView = props => {
  return (
    <AdminLayout
      pageName="Supply Items"
      pageSubtitle="Register individual supply items"
